  ...
  return (
    ...
    >
      <div className="relative inline-block">
        <div className="text-3xl md:text-5xl font-black text-white/50 transition-all duration-700 group-hover:text-white tracking-tighter uppercase italic py-2 whitespace-nowrap">
          {text}
        </div>
